...
def friend_requests(request, *args, **kwargs): # get friend request list
    context = {}
    user = request.user
    if user.is_authenticated:
        user_id = kwargs.get('user_id')
        ...
        if account == user:
            ...
            return HttpResponse("You can't view another users friend request")
    else:
...
def send_friend_request(request, *args, **kwargs):
    ...
    if request.method == 'POST' and user.is_authenticated:
        ...
        if user_id:
            ...
            except FriendRequest.DoesNotExit:
    ...
    if request.method == 'POST' and user.is_authenticated:
        ...
        if user_id:
            try:
                ...
                # friend list of authenticated user
...
def cancel_friend_request(request, *args, **kwargs):
    ...
    if request.method == 'POST' and user.is_authenticated:
        ...
        if user_id:
            ...
            # There should only ever be a single active friend request at any single given time.
